        ...
        <div class="item-box-bottom-car">
          ...
          <div class="item-box-bottom-car-right">
            <div class="car-header">
              <p>字典条目</p>
              <div class="btn">
                <div class="el-icon-document-add" @click="ModifyList=true"></div>
                <!-- <div class="el-icon-download"></div> -->
                <!-- <div class="el-icon-delete"></div> -->
              </div>
            </div>
            <div class="table-box">
              <el-table size="mini" stripe height="100%" ref="multipleTable" border="" :data="tableData"
                tooltip-effect="dark" style="width: 100%">
                <el-table-column prop="name" label="名称" show-overflow-tooltip align="center">
                </el-table-column>
                <el-table-column prop="route" label="值" show-overflow-tooltip align="center">
                </el-table-column>
                <el-table-column width="130" label="操作">
                  <template slot-scope="scope">
                    <div class="btn-ul" style="display: flex;justify-content: center;">
                      <el-button size="mini" class="mini-btn" @click="editFun(scope.$index, scope.row)">编辑</el-button>
                      <el-button size="mini" class="mini-btn" type="danger" @click="deleteFun(scope.$index, scope.row)">
                        删除</el-button>
                    </div>
                  </template>
                </el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      handleNodeClick(v) {
        console.log(v)
        this.expandedKeys = [v.id];
        this.activeMenu = v;
        this.getList(this.activeMenu);
      },
      getList() {
        getlist(1).then(_ => {
          console.log(_)
